...
def v1_1_database_with_messages(tmp_path):
    ...
    messages = [
        ...
        ('msg1', '<msg1@example.com>', 'thread1', 'Team meeting tomorrow',
         'alice@example.com', 'team@example.com', None,
         '2024-01-15 10:00:00', '2024-02-01T12:00:00',
         'archive_202402.mbox', 100, 500,
         'Let us discuss the project update', 'checksum1', 500, None, 'default'),

        # Message 2: From Alice about invoice
        ('msg2', '<msg2@example.com>', 'thread2', 'Invoice #1234 for January',
         'alice@example.com', 'billing@example.com', None,
         '2024-02-10 14:30:00', '2024-03-01T12:00:00',
         'archive_202403.mbox', 200, 450,
         'Please find attached the invoice for payment', 'checksum2', 450, None, 'default'),

        # Message 3: From Bob about invoice
        ('msg3', '<msg3@example.com>', 'thread3', 'Invoice payment received',
         'bob@example.com', 'alice@example.com', None,
         '2024-02-15 09:00:00', '2024-03-01T12:00:00',
         'archive_202403.mbox', 700, 380,
         'Thank you for the prompt payment', 'checksum3', 380, None, 'default'),

        # Message 4: From Charlie about report
        ('msg4', '<msg4@example.com>', 'thread4', 'Weekly status report',
         'charlie@example.com', 'team@example.com', None,
         '2024-03-20 16:45:00', '2024-04-01T12:00:00',
         'archive_202404.mbox', 300, 520,
         'Here is the weekly progress report', 'checksum4', 520, None, 'default'),

        # Message 5: From Alice about meeting (later date)
        ('msg5', '<msg5@example.com>', 'thread5', 'Quarterly meeting agenda',
         'alice@example.com', 'team@example.com', None,
         '2024-06-05 11:00:00', '2024-07-01T12:00:00',
         'archive_202407.mbox', 400, 600,
         'Agenda items for the quarterly review meeting', 'checksum5', 600, None, 'default'),
    ]
...
class TestSearchCommand:
    ...
    def test_search_with_query_string(self, runner, v1_1_database_with_messages):
        ...
        result = runner.invoke(app, [
            'search', 'meeting',
            '--state-db', str(v1_1_database_with_messages)
        ])
    ...
    def test_search_v1_0_database_error(self, runner, v1_0_database):
        ...
        assert ('v1.1' in result.stdout.lower() or
                'migrate' in result.stdout.lower() or
                'schema' in result.stdout.lower())
